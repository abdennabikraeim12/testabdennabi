...
"[project]/src/app/components/auth/LoginForm.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const formSchema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"])({
    ...
    password: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"])().min(6, 'Le mot de passe doit contenir au moins 6 caractères')
});
function LoginForm() {
    _s();
    ...
    async function onSubmit(values) {
        setIsLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/login', values);
...
_s(LoginForm, "ce2EZobOH3JZKlJXPidPvLW1Z+M=", false, function() {
    return [
...
//# sourceMappingURL=src_668926e8._.js.map