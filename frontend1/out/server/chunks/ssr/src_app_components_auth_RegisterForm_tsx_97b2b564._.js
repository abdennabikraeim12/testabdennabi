...
const Register = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/register', formData);
            router.push('/login');
        } catch (err) {
            console.log(err);
            setLoading(false);
...
//# sourceMappingURL=src_app_components_auth_RegisterForm_tsx_97b2b564._.js.map